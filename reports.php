...
HEADER;
	...
	if($username){
		...
		print "<table class = \"topMenu\"><tr><td><a href=\"index.php\" class = \"button\">Home</td><td><a href=\"refunds.php\" class = \"button\">Refunds</a></td><td><a href=\"reports.php\" id = \"selected\">Reports</a></td><td><a href=\"mngaccount.php\"  class = \"button\">My Account</a></td>";
	if ($accessLvl == 'S'){
...
function showPage($username='', $accessLvl = '', $errors = ''){
  ...
  print '<a href='.$_SERVER['PHP_SELF'].'?report_id=1>All Refunds</a>';
